...
global hide_control_space_button, display_control_space_button, entry_span, label_title, entry_fps
...
def control_space_window():
    ...
    # 画面折り畳みボタン
    display_hide_button_style = tkinter.ttk.Style()
    display_hide_button_style.configure('MyWidget.TButton', family='Meirio', size=5, weight='bold')
    hide_control_space_button = tkinter.ttk.Button(
        frame_0_0, text="⇑", width=3, command=hide_control_space, style="MyWidget.TButton"
    )
    hide_control_space_button.grid(row=row_idx, column=0, sticky="w")
    hide_control_space_button.grid_remove()
    display_control_space_button = tkinter.ttk.Button(
        frame_0_0, text="⇓", width=3, command=display_control_space, style="MyWidget.TButton"
    )
    display_control_space_button.grid(row=row_idx, column=0, sticky="w")
    label_title = tkinter.Label(frame_0_0, font=label_font2, text="キャプチャ範囲調整")
    label_title.grid(row=row_idx, column=1, columnspan=15, sticky="w")
    row_idx += 1
    ...
    label_fps.grid_remove()
    entry_fps.grid_remove()
    label_fps2.grid_remove()
    change_fps_button.grid_remove()
    row_idx += 1
    ...
    label_span.grid_remove()
    entry_span.grid_remove()
    label_span2.grid_remove()
    row_idx += 1
    # 右
    ...
    label_sizeup_width_right.grid_remove()
    sizeup_width_right_button.grid_remove()
    sizedown_width_right_button.grid_remove()
    row_idx += 1
    # 左
    ...
    label_sizeup_width_left.grid_remove()
    sizeup_width_left_button.grid_remove()
    sizedown_width_left_button.grid_remove()
    row_idx += 1
    # 上
    ...
    label_sizeup_height_top.grid_remove()
    sizeup_height_top_button.grid_remove()
    sizedown_height_top_button.grid_remove()
    row_idx += 1
    # 下
    ...
    label_sizeup_height_bottom.grid_remove()
    sizeup_height_bottom_button.grid_remove()
    sizedown_height_bottom_button.grid_remove()
    row_idx += 1
    ...
    checkbox_mask_check.grid_remove()
    row_idx += 1
    ...
    checkbox_judge_line.grid_remove()
    row_idx += 1

    # saveボタン
    save_button = tkinter.ttk.Button(frame_0_0, text="save", width=4, command=save_config, style="MyWidget.TButton")
    save_button.grid(row=row_idx, column=0, padx=3, pady=3, columnspan=3, sticky="w")
...
def hide_control_space():
    global display_control_space_button, label_title
...
canvas_monitor.grid(row=0, column=0, sticky="n")
canvas_vr.grid(row=1, column=0, sticky="n")
canvas_vr_max.grid(row=2, column=0, sticky="n")

# VR解析結果
label_text = tkinter.StringVar()
label_vr_percent = tkinter.Label(frame_1_0, fg="green", font=label_font, textvariable=label_text)
label_vr_percent.grid(row=3, column=0)
